...
service.controller('SecurityController', ['authService', '$location', '$scope', function (authService, $location, $scope) {
  $scope.permit = function () {
    if (!authService.allowed(arguments)) {
...
service.factory('authService', ['$rootScope', '$store', function($rootScope, $store) {
  return {
    /**
